...
var ARG_TYPOS = {
    ...
    '-port': 'Did you mean \'--port\'? May be you have a typo',
    '--P': 'Did you mean \'-P\'? May be you have a typo',
    '-user-password': 'Did you mean \'--user-password\'? May be you have a typo',
    '--UP': 'Did you mean \'-UP\'? May be you have a typo',
    ...
    '-dont-daemonize': 'Did you mean \'--dont-daemonize\'? May be you have a typo',
    '--DD': 'Did you mean \'-DD\'? May be you have a typo',
    '-stop': 'Did you mean \'--stop\'? May be you have a typo',
    '--S': 'Did you mean \'-S\'? May be you have a typo'
};

function checkArgs(){
    for(var i = 0 ; i < process.argv.length ; i++){
        if(!_.isUndefined(ARG_TYPOS[process.argv[i]])){
            console.log(ARG_TYPOS[process.argv[i]]);
            return false;
        }
    }
...
function tryShutDownDaemon(){
    ...
    try{
        fsAccess.sync(FTPD_PID_FILENAME);
    } catch(err){
        console.log('Reading daemon PID... [NO DAEMON PID FOUND]');
        return true;
    }
...
function tryDaemonizeThis(){
    ...
    console.log('Spawning new daemon process...');
    ...
    console.log('Spawning new daemon process... [OK]');
    console.log('New daemon process PID is '+ child.pid);
...
function printHelp(){
    ...
    console.log(' ' + DONT_DAEMONIZE_ARG_SHORT + ', ' + DONT_DAEMONIZE_ARG_SHORT + '\t\tDo not daemonize');
